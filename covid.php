			...
			switch ($userResponse) {
			    case "":
			        if($level==0){
						...
						$response = "CON Welcome to M.O.H COVID-19 TRACKER, " . $userAvailable['name']  . ". Choose a service.\n";
						$response .= " 1. Latest Update.\n";
						$response .= " 2. Report a Case\n";
						$response .= " 3. Protect Yourself\n";
						$response .= " 4. Symptoms Checker\n";							
						$response .= " 5. Epicenter Data\n";
						$response .= " 6. Tell a Friend\n";
						$response .= " 7. Get SMS ALERTS\n";	
						$response .= " 8. Request a Voice call\n";
                        $response .= " 9. Exit\n";																							
			    ...
			    case "0":
			        if($level==0){
			        	...
			        	//Serve our services menu
						$response = "CON Welcome to M.O.H COVID-19, " . $userAvailable['username']  . ". Choose a service.\n";
						$response .= " 1. Latest Update.\n";
						$response .= " 2. Report a Case\n";
						$response .= " 3. Protect Yourself\n";
						$response .= " 4. Symptoms Checker\n";							
                    ...
                    case "1":
                        if($level==1){
                            ...
                            $response .= "1. General Data\n";
                            $response .= "2. Epicenter Data\n";
			...
			switch ($level){
			    ...
			    case 10: 
					...
					switch ($userResponse) {
					    case "1":
					    	//Find account
						$response = "END MINISTRY OF HEALTH COVID-19 UPDATE.\n";
						$response .= "DATE: 14/04/2020.\n";
						$response .= "TOTAL CASES CONFIRMED: 45\n";	
						$response .= "ACTIVE CASES: 13\n";		
						$response .= "TOTAL RECOVERED: 30\n";	
						$response .= "TOTAL DEATHS: 2\n";																														
							// Print the response onto the page so that our gateway can read it
							header('Content-type: text/plain');
						  	echo $response;	
					    break;
